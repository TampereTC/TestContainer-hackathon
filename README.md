...
- It is doable to convert docker-compose yml files to Kubernetes format by [Kompose tool:](http://kompose.io/). However configuring volume mounting seems to be a bit tricky and requires extra work to do. Roughly 70% of containers were succesfully converted to Kubernetes PODs yaml format.
...
- Following diagram discribes how each of the container bundles are related to yaml files and how they are integrated.
